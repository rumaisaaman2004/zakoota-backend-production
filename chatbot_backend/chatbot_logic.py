...
class Chatbot:
    def __init__(self):
        ...
        self.legal_qa = {
            ...
            # Quick Responses
            'hello': 'Hello! I\'m Zakoota Legal Assistant. How can I help you today?',
    ...
    def _get_groq_response(self, message, user_type):
        ...
        try:
            ...
            if user_type == 'lawyer':
                ...
                system_prompt = "You are Zakoota Legal Assistant, helping users with Pakistan laws. Provide accurate, simple explanations. If complex, recommend consulting a lawyer. Always cite relevant laws if known."
    ...
    def _greet_user(self, user_type):
        ...
        if user_type == 'client':
            return "Hello! I'm Zakoota Legal Assistant. How can I help you find a lawyer today?"
        elif user_type == 'lawyer':
            return "Hello Counselor! How can I assist you with legal information today?"
        else:
            return "Hello! I'm Zakoota Legal Assistant. How can I help you?"
